    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/meal.ProductInShoppingList"
                        }
                    }
                ],
                "responses": {
        ...
        "/shopping-lists": {
            "get": {
                ...
                "description": "Get all shopping lists (without products)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/meal.ShoppingList"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "meal.ProductInShoppingList": {
            ...
            "properties": {
                ...
                "quantity": {
                    "description": "ILOSC / WAGA_JEDNOSTKI",
                    "type": "number"
                },
                "weight": {
                    "description": "This corresponds to ILOSC (total weight)",
                    "type": "number"
                }
            }
        },
