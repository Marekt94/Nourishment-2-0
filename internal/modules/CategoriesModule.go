...
func (m *ModuleCategories) RegisterPermissions() {
	...
	m.PermRepo.RegisterUserPermission(ADMIN_USER_NAME, api.RESOURCE_CATEGORIES, "read")
	m.PermRepo.RegisterUserPermission(ADMIN_USER_NAME, api.RESOURCE_CATEGORIES, "write")
	m.PermRepo.RegisterUserPermission(READER_USER_NAME, api.RESOURCE_CATEGORIES, "read")
}
